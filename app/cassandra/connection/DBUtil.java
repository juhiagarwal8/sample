...
public class DBUtil {
	 ...
	 */
	public static void checkCassandraDbConnections() throws Exception {
		CassandraConnectionManager cassandraConnectionManager = CassandraConnectionMngrFactory.getInstance();
		String nodes = System.getenv(JsonKey.CASSANDRA_IP);
		String[] hosts = null;
